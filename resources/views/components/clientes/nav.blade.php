...
<div>
<nav class="bg-neutral-primary fixed top-0 left-5  right-5 z-20 border-b rounded-base border border-default shadow-sm">
    <div class="max-w-7xl flex flex-wrap items-center justify-between mx-auto px-4 py-2">
        <a href="{{ url('/admin') }}" class="flex items-center space-x-3 rtl:space-x-reverse">
            <img src="{{ asset('images/logo.png') }}" class="h-7" alt="Ariosa Logo" />
            ...
            <ul class="font-medium flex flex-col p-4 md:p-0 mt-4 border border-default rounded-base bg-neutral-secondary-soft md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-neutral-primary">
                ...
                <li>
                    <a href="{{ url('/registro-clientes') }}"
                        class="block py-2 px-3 text-heading rounded hover:bg-neutral-tertiary md:hover:bg-transparent md:border-0 md:hover:text-fg-brand md:p-0 md:dark:hover:bg-transparent">Nuevo Cliente</a>
                </li>
                <li>
                    <a href="#"
                        class="block py-2 px-3 text-heading rounded hover:bg-neutral-tertiary md:hover:bg-transparent md:border-0 md:hover:text-fg-brand md:p-0 md:dark:hover:bg-transparent">Modificar</a>
                </li>
                <li>
                    <a href="#"
                        class="block py-2 px-3 text-heading rounded hover:bg-neutral-tertiary md:hover:bg-transparent md:border-0 md:hover:text-fg-brand md:p-0 md:dark:hover:bg-transparent">Editar</a>
                </li>
            </ul>
        </div>
    </div>
